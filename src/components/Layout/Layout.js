...
import {
  ...
  CircleDollarSign, Gem, Bot, Download, Sparkles, Shirt,
} from 'lucide-react';
...
const MENU_ITEMS = [
  ...
  { path: '/recommendations', icon: Sparkles, label: 'Recomendaciones' },
  { path: '/messi-lineup', icon: Shirt, label: 'Alineación Messi' },
